...
version_info = ('networkx', 1, 4, '7f42e7950c95')

# Format: a 'datetime.datetime' instance
date_info = datetime.datetime(2011, 1, 23, 15, 44, 24, 373678)

# Format: (vcs, vcs_tuple)
vcs_info = ('mercurial', ('7f42e7950c95', 'tip'))
